(() => {
  ...
  namespace.createMarketing = () => {
    ...
    template.innerHTML = `
      ...
      <section class="marketing-section final-cta" data-reveal data-reveal-delay="1"><div class="final-cta-copy"><span class="section-kicker">Your edge is waiting</span><h2>Every League Has an Edge.<br>Find Yours.</h2><p>Paste the same Sleeper league ID or URL into the importer above. The existing analyzer remains the engine underneath this presentation layer.</p></div><a class="final-cta-link" href="#leagueId">Import from Sleeper <svg width="16" height="11" viewBox="0 0 16 11" aria-hidden="true"><path d="M1 5.5h13M10 1l4.5 4.5L10 10" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/></svg></a></section>
    `;
    return template.content;
  };

  namespace.createFooter = () => namespace.element(`
    <footer class="site-footer"><div class="footer-inner"><div class="footer-brand"><a class="brand brand-lockup" href="#top"><svg class="brand-mark" viewBox="0 0 48 48" aria-hidden="true"><path fill="#e7b84f" d="M3 8h10.5L24 25.2 34.5 8H45L24 43z"/><path fill="#050705" d="M13.4 12h6.9l3.7 6.1 3.7-6.1h6.9L24 29.4z"/></svg><span class="brand-copy">LEAGUE VECTOR<small>Dynasty + IDP Intelligence</small></span></a><p>League-aware fantasy intelligence for managers who want transparent data, serious IDP context and better long-term decisions.</p></div><div class="footer-column"><h3>Product</h3><a href="#features">Features</a><a href="#league-context">League context</a><a href="#methodology">Methodology</a></div><div class="footer-column"><h3>Analyze</h3><a href="#leagueId">Import league</a><a href="#results">League results</a><a href="#top">Overview</a></div><div class="footer-column"><h3>Principles</h3><a href="#methodology">Evidence</a><a href="#methodology">Data quality</a><a href="#features">IDP context</a></div></div><div class="footer-bottom"><span>© 2026 League Vector. Foundation v0.8.</span><div class="footer-bottom-links"><a href="#top">Back to top</a><span>Every League Has an Edge. Find Yours.</span></div></div></footer>
  `);
})();
