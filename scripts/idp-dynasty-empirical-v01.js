...
async function buildHistoricalPlayerSeasons(options={}){
  ...
  return {seasons,retrievedAt,observations:observations.length,playerSeasons:Age.buildPlayerSeasons(observations,playerBio)};
}
