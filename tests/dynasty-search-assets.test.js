...
test('production dynasty search assets are explicit and cache-busted', () => {
  ...
  assert.match(html, /dynasty-search-v01\.js\?v=0\.3/);
  assert.doesNotMatch(html, /live-test-fixes-v01\.js\?v=0\.1/);
  assert.doesNotMatch(html, /dynasty-search-v01\.js\?v=0\.2/);
  assert.equal((html.match(/dynasty-search-v01\.js\?v=0\.3/g) || []).length, 1);
